      ...
      setSystemTemplates([
        {
          ...
          elements: [],
          layout: { width: 600, height: 800, backgroundColor: '#ffffff' },
          createdAt: new Date(),
          updatedAt: new Date(),
          isPublic: true,
          category: 'Newsletter',
        },
        {
          ...
          elements: [],
          layout: { width: 600, height: 600, backgroundColor: '#f8f9fa' },
          createdAt: new Date(),
          updatedAt: new Date(),
          isPublic: true,
          category: 'Promotion',
        },
        {
          ...
          elements: [],
          layout: { width: 600, height: 700, backgroundColor: '#ffffff' },
          createdAt: new Date(),
          updatedAt: new Date(),
          isPublic: true,
        ...
        },
        {
          ...
          elements: [],
          layout: { width: 600, height: 800, backgroundColor: '#f0f8ff' },
          createdAt: new Date(),
          updatedAt: new Date(),
          isPublic: true,
          category: 'Événement',
  ...
  const TemplateCard: React.FC<{ template: EmailTemplate; isSystem?: boolean }> = ({ 
    ...
    >
      ...
      <div style={{
        width: '100%',
        height: '120px',
        backgroundColor: template.layout.backgroundColor || '#f8f9fa',
